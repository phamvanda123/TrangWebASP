<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="QuanLySanPham.aspx.cs" Inherits="project_ASP.admin.QuanLySanPham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    Hãng
    <asp:DropDownList ID="DropDownHang" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownHang_SelectedIndexChanged" DataSourceID="SqlDataSource2" DataTextField="TenHang" DataValueField="MaHang"></asp:DropDownList>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" ShowFooter="True" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Đánh giá">
                        <EditItemTemplate>
                            <asp:DropDownList ID="cb_DanhGia" runat="server">
                                <asp:ListItem>
                                    1
                                </asp:ListItem>
                                <asp:ListItem>
     ...
     <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=DESKTOP-86P3HHV\SQLEXPRESS;Initial Catalog=QuanLyTrangWebASP;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Hang]"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="Data Source=DESKTOP-86P3HHV\SQLEXPRESS;Initial Catalog=QuanLyTrangWebASP;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [SANPHAM] WHERE ([MaHang] = @MaHang)">
         <SelectParameters>
             <asp:ControlParameter ControlID="DropDownHang" Name="MaHang" PropertyName="SelectedValue" Type="String" />
         </SelectParameters>
         </asp:SqlDataSource>
</asp:Content>
